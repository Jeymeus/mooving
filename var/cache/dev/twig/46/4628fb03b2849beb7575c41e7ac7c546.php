...
class __TwigTemplate_5700df9fbd31d41daa9e79c97e1bd74c extends Template
{
    private $source;
    private $macros = [];
    ...
    <body class=\"bg-warning-subtle\">
        {% if app.request.attributes.get('_route') != 'home' %}
            <header>
                <nav class=\"navbar navbar-expand-lg bg-warning\">
                    <div class=\"container-fluid\">
                        <a class=\"navbar-brand\" href=\"{{ path('admin_vehicle_index') }}\">Administration</a>
                        <button class=\"navbar-toggler\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#navbarNav\" aria-controls=\"navbarNav\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
                            <span class=\"navbar-toggler-icon\"></span>
                        </button>
                        <div class=\"collapse navbar-collapse\" id=\"navbarNav\">
...
", "admin/admin.html.twig", "C:\\Users\\Ikki\\Desktop\\mooving\\templates\\admin\\admin.html.twig");
    }
}
